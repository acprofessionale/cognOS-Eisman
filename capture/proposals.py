...
No AI provider is invoked here. This module only persists a proposal produced by
an external actor (human or AI) without mutating the raw capture receipt.
"""
...
def load_receipt(path: Path) -> dict:
    ...
    sha256 = receipt.get("content", {}).get("sha256")
...
def write_proposal(
    ...
    out_dir = root.expanduser() / "proposals"
